...
void Objetos::dibujarObjeto(float radio, float _ESCALA, float _STAY_X, float _STAY_Y, float _STAY_Z, float _ROTATION, float _X, float _Y, float _Z) {
  if (CONO==true)
  {
    dibujaCono(radio);
  }
...
void Objetos::escalar()
{
  glScalef(ESCALA, ESCALA, ESCALA);
}

void Objetos::transladar()
{
  glTranslatef(STAY_X, STAY_Y, STAY_Z);
}
